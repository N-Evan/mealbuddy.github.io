        ...
        <div class="col-md-6">
          <div class="form_container">
            <form action="confirm.php" method="post">
              ...
              <div>
                <input type="text" class="form-control" placeholder="Phone Number" id="cont_num" name="cont_num" />
              </div>
              <div>
                <input type="email" class="form-control" placeholder="Your Email" id="email" name="email" />
              </div>
              <div>
                <input type="address" class="form-control" placeholder="Delivery Address" id="delv_adr" name="delv_adr" />
              </div>
              <div class="btn_box">
                <button>
                  Confirm Order!
